...
CREATE TABLE IF NOT EXISTS `client` (
    ...
    `comment` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT "Комментарий",
...
CREATE TABLE IF NOT EXISTS `contract` (
    ...
    `comment` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT "Примечание",
    `employee_id` int(11) COMMENT "Ответственный",
...
VALUES (
        ...
        1,
        1,
        'Сопровождение дела по земельным спорам',
        1,
        1,
        '2023-01-01',
        '2023-12-31'
    ...
    (
        ...
        3,
        1,
        'Консультация и представление интересов',
        3,
        3,
        '2023-05-10',
        '2023-11-10'
...
CREATE TABLE IF NOT EXISTS `news` (
    ...
    CONSTRAINT `news_ibfk_1` FOREIGN KEY (`author_id`) REFERENCES `employee` (`employee_id`)
...
VALUES (
        ...
        'Мы рады объявить о запуске нового проекта...',
        1,
        '2024-06-28'
    ),
    (
        ...
        'Недавно были внесены изменения в законодательство...',
        2,
        '2024-06-27'
    ),
    (
        3,
        'Новое событие',
        'Приглашаем вас на наше новое мероприятие...',
        3,
        '2024-06-26'
    );

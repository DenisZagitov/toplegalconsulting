 ...
 if (mysqli_num_rows($q)>0)
  {
	 ...
	 echo ' <table width="100%" border="2" cellspacing="2" cellpadding="2">
      ...
      if ($vid=='catalog') echo  '<a href="http://toplegalconsulting.com/?vid=catalog&type='.$_GET['type'].'&sort=Номер_договора">Номер_договора </font></a>';
   ...
   while ($row = mysqli_fetch_array($q, MYSQLI_ASSOC))
    {   
      ...
      if (isset ($_SESSION['id_client']))  echo '<a href="toplegalconsulting.com/read.php">';
      else  echo '<a href="http://toplegalconsulting.com/read.php">';  
      echo '
